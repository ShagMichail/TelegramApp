...
public extension Api.auth {
    enum Authorization: TypeConstructorDescription {
        ...
        case signUp(flags: Int32, phoneNumber: String, phoneCodeHash: String, firstName: String, lastName: String, modelInfo: Api.ModelInfo?)
        ...
        public static func parse_signUp(_ reader: BufferReader) -> Authorization? {
            ...
            var _6: Api.ModelInfo?
            if Int(_1!) & Int(1 << 1) != 0 {if let signature = reader.readInt32() {
                _6 = Api.parse(reader, signature: signature) as? Api.ModelInfo
            } }
            let _c1 = _1 != nil
            let _c2 = _2 != nil
            let _c3 = _3 != nil
            ...
            if _c1 && _c2 && _c3 && _c4 && _c5 && _c6 {
                return Api.auth.Authorization.signUp(flags: _1!, phoneNumber: _2!, phoneCodeHash: _3!, firstName: _4!, lastName: _5!, modelInfo: _6)
            }
            else {
                return nil
            }
